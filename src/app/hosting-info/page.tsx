          ...
          <div className="space-y-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <div className="flex items-start">
                <div className="flex-shrink-0 mr-4">
                  <Image
                    src="https://ext.same-assets.com/1334220929/3347127158.jpg"
                    alt="Netlify"
                    width={60}
                    height={60}
                    className="rounded"
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <div className="flex items-start">
                <div className="flex-shrink-0 mr-4">
                  <Image
                    src="https://ext.same-assets.com/1334220929/107608747.jpg"
                    alt="Vercel"
                    width={60}
                    height={60}
                    className="rounded"
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <div className="flex items-start">
                <div className="flex-shrink-0 mr-4">
                  <Image
                    src="https://ext.same-assets.com/1334220929/3289923909.jpg"
